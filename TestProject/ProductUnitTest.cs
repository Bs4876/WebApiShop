...
namespace TestProject
{
    public class ProductUnitTest
    {
        ...
        {
            // Arrange
            var products = new List<ProductsTbl>
            {
                new ProductsTbl { ProductId = 1, ProductName = "Product1", ProductPrice = 100, CategoryId = 1 },
                new ProductsTbl { ProductId = 2, ProductName = "Product2", ProductPrice = 200, CategoryId = 2 },
                new ProductsTbl { ProductId = 3, ProductName = "Product3", ProductPrice = 150, CategoryId = 1 }
            };
        ...
        public async Task GetProducts_ReturnsZeroWhenNoProductsMatchCriteria()
        {
            // Arrange
            _mockRepository.Setup(repo => repo.getProducts(It.IsAny<int?[]>(), It.IsAny<int?>(), It.IsAny<int?>(), It.IsAny<int>(), It.IsAny<int>()))
                           .ReturnsAsync((new List<ProductsTbl>(), 0));
